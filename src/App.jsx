  ...
  return (
    <div className="space-y-4">
      {text.trim().split(/\n\s*\n/).map((para, i) => (
        <p
          key={i}
          className="text-base leading-8 text-[#000000]"
...
export default function LibyaStabilityLandingPage() {
  return (
    <div className="min-h-screen bg-[#f5f1e8] text-[#0d2240]">
      ...
      <header className="sticky top-0 z-50 border-b border-[#d8c48a]/50 bg-[#0d2240]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.35em] text-[#d8c48a]">Official Communiqué</div>
              <div className="text-lg font-semibold text-white sm:text-xl">SLPM-PC</div>
            </div>
          </div>

          <nav className="hidden items-center gap-6 text-sm text-white/85 md:flex">
            <a href="#home"         className="transition hover:text-[#d8c48a]">Home</a>
            <a href="#announcement" className="transition hover:text-[#d8c48a]">Announcement</a>
            <a href="#outcomes"     className="transition hover:text-[#d8c48a]">Outcomes</a>
            <a href="#contact"      className="transition hover:text-[#d8c48a]">Contact</a>
          </nav>
        </div>
      </header>
      ...
      <main>
        ...
        {/* ===== HERO ===== */}
        <section id="home" className="relative overflow-hidden bg-[#0d2240] text-white">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
            ...
            <div className="relative z-10 flex flex-col justify-center">
              ...
              <h1 className="max-w-2xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
                ...
                <br />and National Unity
              </h1>
              <p className="mt-6 max-w-xl text-base leading-8 text-white/80 sm:text-lg">
                A preliminary official website layout for the announcement, updates,
                and future article publications.
              </p>
            ...
            <div className="relative z-10">
              <div className="overflow-hidden rounded-[28px] border border-white/10 bg-white/5 shadow-2xl backdrop-blur-sm">
                <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
                  <div>
                    <p className="text-xs uppercase tracking-[0.3em] text-[#d8c48a]">Intro Video</p>
                    <p className="mt-1 text-sm text-white/70">Official teaser video</p>
                  </div>
        ...
        {/* ===== ANNOUNCEMENT ===== */}
        <section id="announcement" className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="overflow-hidden rounded-[34px] border border-[#d8c48a]/35 bg-white shadow-[0_24px_70px_rgba(13,34,64,0.08)]">
            ...
            <div className="border-b border-[#e4e7ee] bg-[#f8fbff] px-6 py-5 sm:px-8 lg:px-10">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="text-sm text-[#556882]">REF: LY/GVA/2026/APR | April 2026</div>
              </div>
            </div>
            ...
            <div className="px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
              ...
              <div className="mt-8 space-y-8">
                ...
                <div className="rounded-[28px] border border-[#dce3ef] bg-[#fbfcfe] p-6 sm:p-7">
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#1c9ae4]">I.</p>
                  <h3 className="mt-2 text-2xl font-bold text-[#0d2240] sm:text-3xl">BACKGROUND AND CONTEXT</h3>
                  <div className="mt-5">
                ...
                {/* Section II */}
                <div className="rounded-[28px] border border-[#dce3ef] bg-[#fbfcfe] p-6 sm:p-7">
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#1c9ae4]">II.</p>
                  <h3 className="mt-2 text-2xl font-bold text-[#0d2240] sm:text-3xl">STRATEGIC RATIONALE</h3>
                  <div className="mt-5">
                ...
                {/* Section III — Table */}
                <div id="outcomes" className="rounded-[28px] border border-[#dce3ef] bg-[#fbfcfe] p-6 sm:p-7">
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#1c9ae4]">III.</p>
                  <h3 className="mt-2 text-2xl font-bold text-[#0d2240] sm:text-3xl">KEY EXPECTED OUTCOMES</h3>
                  <div className="mt-6 overflow-hidden rounded-[16px] border border-[#dce3ef]">
                    <table className="min-w-full border-collapse">
                      <thead>
                        <tr className="bg-[#0d2240] text-left text-white">
                          <th className="px-5 py-3 text-sm font-semibold uppercase tracking-[0.2em]">Pillar</th>
                          <th className="px-5 py-3 text-sm font-semibold uppercase tracking-[0.2em]">Details & Expected Outcomes</th>
                        </tr>
                      </thead>
                      <tbody>
                        {outcomesRows.map((row, index) => (
                          <tr key={row.pillar} className={index % 2 === 0 ? "bg-[#fbfcfe]" : "bg-white"}>
                            <td className="border-t border-[#e5ebf3] px-5 py-4 align-top font-semibold text-[#0d2240]">{row.pillar}</td>
                            <td className="border-t border-[#e5ebf3] px-5 py-4 text-sm leading-7 text-[#546880]">{row.details}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
        ...
        <section id="contact" className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8 lg:pb-24">
          <div className="rounded-[32px] border border-[#d8c48a]/40 bg-white p-6 shadow-[0_20px_60px_rgba(13,34,64,0.08)] sm:p-8 lg:p-10">
            <div className="mb-8 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.35em] text-[#8a7440]">Contact Information</p>
              <h3 className="mt-3 text-3xl font-bold text-[#0d2240]">For inquiries and communication</h3>
              <p className="mt-3 text-[#50627d]">
                You can keep this block at the end of the website for fast access to contact details.
              </p>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-[24px] border border-[#d7deea] bg-[#f8fbff] p-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#6f7f96]">Email</p>
                <a href="mailto:Info@slpm-pc.org"
              ...
              <div className="rounded-[24px] border border-[#d7deea] bg-[#f8fbff] p-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#6f7f96]">WhatsApp</p>
                <a href="https://wa.me/41783403437"
              ...
              <div className="rounded-[24px] border border-[#d8c48a]/50 bg-[#0d2240] p-6 text-white md:col-span-2 lg:col-span-1">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#d8c48a]">Status</p>
                <p className="mt-3 text-xl font-semibold">Site under preparation</p>
                <p className="mt-2 text-sm leading-7 text-white/75">
                  This initial version is built to publish the official announcement and upcoming article details.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-[#0d2240] text-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            <p className="text-sm text-white/70">Libya Awakens, and the World Witnesses</p>
            <p className="mt-2 text-xs uppercase tracking-[0.25em] text-[#d8c48a]">
              #LibyaUnited #GenevaApril #LibyaFuture
            </p>
          </div>
          <div className="text-sm text-white/70">
            Preparatory Committee for the Geneva Meeting<br />
